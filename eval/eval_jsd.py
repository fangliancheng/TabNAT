...
if __name__ == '__main__':
    ...
    quality_evaluator = eval_statistical.JensenShannonDistance()
    qual_res = quality_evaluator.evaluate(X_real_loader, X_syn_loader)
    print(f'Jensen-Shannon Distance: {qual_res["marginal"]}')

    # Precision_all = qual_res['precision']
    # Recall_all = qual_res['recall']
    # Density_all = qual_res['density']
    # Coverage_all = qual_res['coverage']
    ...
    #     f.write(f'Precision: {Precision_all}\n')
    #     f.write(f'Recall: {Recall_all}\n')
    #     f.write(f'Density: {Density_all}\n')
    #     f.write(f'Coverage: {Coverage_all}\n')
