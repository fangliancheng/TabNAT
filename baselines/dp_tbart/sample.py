...
def main(args):
    ...
    model.load_state_dict(torch.load(f'TabART/checkpoints/{dataname}/model_{embed_dim}_{buffer_size}_{depth}_{args.padding}.pt'))
    ...
    save_path = f'{script_path}/../../synthetic/{dataname}/tabart_{embed_dim}_{buffer_size}_{depth}_{args.padding}.csv'
