...
def main(args):
    ...
    best_loss = np.inf
    patience = 1000
    if not os.path.exists(f'TabMT/checkpoints/{dataname}'):
        os.makedirs(f'TabMT/checkpoints/{dataname}')
    ...
    for epoch in range(args.epochs):
        ...
        # if epoch % 10 == 0:
        #     torch.save(model.state_dict(), f'TabMT/checkpoints/{dataname}/model_{args.embed_dim}_{args.buffer_size}_{args.depth}_{args.padding}.pt')
    end_time = time.time()
